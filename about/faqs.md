...
Sharing Devnotes is the primary way of contributing to Nucleus. DevNotes are built with open source and open science practices in mind. See our [DevNote Contribute](https://devnotes.nucleus.engineering/contribute) page for more information. Additional information can be found on our [Open Science](https://nucleus.bnext.bio/Open-science-1a1ae616eb51808ab804cc56fba9f514) page. If you’d like to get started as a Nucleus Developer, reach out to  [build@bnext.bio](mailto:build@bnext.bio) or post a question on the [Forum](https://forum.nucleus.engineering/) and we would be happy to have a conversation.

### 3. What if I have a module that I want to contribute but is subject to a patent?

This depends on who is the patent holder. If your university holds the patent, you may have to petition them to license the contribution using a suitable tool that provides a patent license. Nucleus uses the permissive variant of the CERN Open Hardware License ([CERN-OHL-P-2.0](https://opensource.org/license/cern-ohl-p)), which includes specific provisions for handling patented subject matter. In general, unless a technology is being actively commercialized, a patent can hinder innovation if it prevents the technology from being used by others. Open access licensing will help fulfill the goals of making technology available for the public benefit in such instances.

### 4. What if I want to patent something built with Nucleus components?

Our licensing scheme allows this. We want Nucleus to encourage innovation including patents. However, we hope that Nucleus can function as “take a penny, leave a penny” to enable the broader community.
...
### 6. Does the OpenMTA stipulate that people that get this material cannot resell it?
