...
Assemble `pT7-lacO-plamGFP` into a standard PURE reaction. Add purified LacI protein to a final concentration of 500–1000 nM, or include the `pT7-lacI` DNA construct. Add IPTG inducer at 500–2000 nM for effective induction. 
