...
| Cascade | [London Cascade](../../modules/london-cascade/spec.md) | legs confirmed separately |
...
No integrated performance data exists. Confirmed results sit at the level of individual legs, on the Module pages above.

:::{attention} Open integration steps
1. **GFP and color-change legs have not been combined.** Each works; the device needs both in one construct.
