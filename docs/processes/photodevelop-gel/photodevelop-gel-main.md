...
1. **Dissolve the precursor** in an aqueous buffer, and add the LAP photoinitiator.
...
| --- | --- | --- |
| Mechanism | chain-growth radical polymerization | step-growth thiol-ene |
| Separate crosslinker | none | PEG4SH |
