...
| | Data source | Modules |
| --- | --- | --- |
| [**Cell**](./cell.md) | Microscopy — a segmented plate zarr | `cdk.analysis.cell` |
| [**Cytosol**](./cytosol.md) | Plate reader — BioTek kinetic, endpoint, spectral | `cdk.instruments.platereader`, `cdk.analysis.cytosol` |
