...
flowchart LR
    ...
    PLA1 -->|"PLA1 expressed,\nlyses own + neighboring liposome"| LYSIS["Lysis:\nCPRG released from\nneighboring liposome"]
...
Developed by Sung-Won Hwang (Liu Lab, Chicago node) — the pH sensing result (14 Aug 2026 status deck, slide 9).

Developed by Samuel Chen (Liu Lab, Chicago node) — spatially confined colorimetric readout in patterned agarose (slide 10).

This page composes those two results. The combined three-part cascade has not been demonstrated end to end.
