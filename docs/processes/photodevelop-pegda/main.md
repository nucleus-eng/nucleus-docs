...
The CPRG photobleaching applies to both routes, not to PEG-norbornene alone — it follows from the UV exposure they share, and is stated once on [Photodevelop Gel](../photodevelop-gel/photodevelop-gel-main.md). A spatial-patterning demonstration (a block-pattern color change in agarose) was repeated with a PEG-norbornene outer gel and LacZ added on top, with the color change still observed after roughly 1.5 h. That is a PEG-norbornene result and should not be cited as PEGDA data.
:::
